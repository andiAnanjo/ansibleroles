...
/usr/bin/echo "STEP 04" >> /root/rsync.out
/usr/bin/mount -t auto /dev/mapper/rootvg-varlv /var_mnt
/usr/bin/mount -t auto /dev/mapper/rootvg-loglv /var_mnt/log
/usr/bin/mount -t auto /dev/mapper/rootvg-auditlv /var_mnt/log/audit
/usr/bin/mount -t auto /dev/mapper/rootvg-optlv /opt_mnt
